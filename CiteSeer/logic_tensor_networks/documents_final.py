...
for seed in range(0, 10):
    ...
    model_file_name = "LTN_final_{}_{}_{}_{}_{}_{}_{}_{}_{}_{}".format(seed, nb_epochs, batch_size, 
        learning_rate, p_forall, p_exists, p_forall_cites, p_exists_cites, dropout_rate, move_to_test_set_ratio)
