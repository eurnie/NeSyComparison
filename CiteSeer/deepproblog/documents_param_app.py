            ...
            for learning_rate in [0.001, 0.0001]:
                for batch_size in [2, 8, 32, 128]:
                    ...
                    model_file_name = "DeepProbLog_param_{}_{}_{}_{}_{}_{}".format(seed, 
                        nb_epochs, batch_size, learning_rate, dropout_rate, loss_function_name)
                    ...
                    if not os.path.isfile(model_file_location):
                        ...
                        for epoch in range(nb_epochs):
                            train = train_model(model, loader, 1, log_iter=100, profile=0, loss_function_name=loss_function_name)
