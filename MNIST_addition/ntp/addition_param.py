...
if dataset == "mnist":
    ...
    train_path, dev_path, _ = create_datasets("../data/MNIST/processed/train.txt",
        "../data/MNIST/processed/test.txt", size_val)
elif dataset == "fashion_mnist":
    generate_dataset_fashion_mnist(seed, 0)
    train_path, dev_path, _ = create_datasets("../data/FashionMNIST/processed/train.txt",
        "../data/FashionMNIST/processed/test.txt", size_val)

# generate name of file that holds the trained model
model_file_name = "param/NTP_param_{}_{}_{}_{}_{}_{}_{}_{}_{}_{}_{}_{}_{}_{}_{}_{}_{}_{}_{}_{}_{}_{}_{}_{}_{}_{}_{}".format(
...
data = Data(train_path=train_path, dev_path=_, test_path=dev_path,
