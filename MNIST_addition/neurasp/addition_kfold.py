...
if dataset == "mnist":
    ...
    processed_data_path = "/../data/MNIST/processed/train.txt"
elif dataset == "fashion_mnist":
    generate_dataset_fashion_mnist(seed, 0)
    datasets = datasets_fashion_mnist
    processed_data_path = "/../data/FashionMNIST/processed/train.txt"

# import train set
dataList_train_total = []
obsList_train_total = []
for i in range(0, 30000, 3000):
    trainDataset = MNIST_Addition(datasets["train"], dir_path + processed_data_path,
