...
for epoch in range(nb_epochs):
    # training
    train_modified(train_set, train_step, p_forall, p_exists, 1)

    # generate name of folder that holds all the trained models
    model_file_name = "LTN_param_{}_{}_{}_{}_{}_{}_{}_{}".format(seed, epoch + 1, batch_size, 
            learning_rate, p_forall, p_exists, dropout_rate, size_val)
