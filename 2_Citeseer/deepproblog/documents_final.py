...
import time
import torch
from import_data_new import import_datasets, Citeseer_train#, Citeseer_val, Citeseer_test
...
def train_and_test(model_file_name, train_set, val_set, test_set, method, nb_epochs, batch_size, 
    ...
    model.add_tensor_source("citeseer", Citeseer_train)
    #model.add_tensor_source("val", Citeseer_val)
